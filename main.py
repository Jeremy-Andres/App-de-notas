...
class Ventana(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.boton_abrir_archivo.place(relx=0.1, rely=0.12, relwidth=0.8)       #botón Abrir

        self.boton_guardar = ttk.Button(self.marco_der,text="Guardar", command= lambda: guardar_archivo(self))
        self.boton_guardar.place(relx=0.1, rely=0.05, relwidth=0.8)             #botón Guardar
...
root.iconphoto(True, tk.PhotoImage(file='notepad.png'))
